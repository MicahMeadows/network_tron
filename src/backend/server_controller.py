...
class ServerController:
    ...
    @staticmethod
    def create_coordinate_proto(coordinate: Coordinate) -> proto_tron_game.Coordinate:
        return proto_tron_game.Coordinate(coordinate.x, coordinate.y)
    
    @staticmethod
    def create_player_dto_proto(player_dto: PlayerDTO) -> proto_tron_game.PlayerDTO:
        new_proto = proto_tron_game.PlayerDTO()
    ...
    @staticmethod
    def create_game_state_proto(game_state: GameState) -> proto_tron_game.GameState:
        new_proto = proto_tron_game.GameState()
    ...
    @staticmethod
    def create_message_proto(message: Message) -> proto_message.Message:
        return proto_message.Message(label=message.label, body=str(message.body))
    ...
    def game_loop(self):
        while True:
            ...
            game_state_data_str = bytes(game_state_proto)
            ...
            game_state_message_data_str = bytes(game_state_message_proto)
